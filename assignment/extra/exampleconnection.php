...
if(isset($_POST['submit']))
{
  ...
  //validation of user input
        ...
        else if (strlen($first) < 3 OR strlen($first) > 30) {
        ...
        else if (strlen($last) < 3 OR strlen($last) > 30) {
        ...
        else if (strlen($middle) < 3 OR strlen($middle) > 30) {
                $error .= '<p>Middle name should be within 3-20 characters long.</p>';
       }
       else if (!preg_match("/^[a-zA-Z ]*$/",$suffix)) {
                $error .="<p>Only letters allowed in your suffix</p>"; 
      }
     else if (strlen($suffix) < 3 OR strlen($suffix) > 30) {
                $error .= '<p>Last name should be within 3-20 characters long.</p>';
      }
     	else if (!preg_match('/^[a-z0-9._-]+@[a-z0-9._-]+\.[a-z]+$/i', $email)) {
