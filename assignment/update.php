...
<body>
	...
	<div class="col-lg-12 well">
		<div class="row">
            ...
            enctype="multipart/form-data" name = "validate_form">
				<div class="col-sm-12">
					<div class="row">
                        <div class ="row">
                        ...
                        <div class="row">
							<div class="col-sm-3 form-group">
								<label>Employement:</label>
      						    <input type="text" id="employement_input" 
                                class="form-control" name="employement" 
                                value="<?php 
                                displayVal("employement", $profile);?>"/>
                                </p></br>	
							...
							<div class="col-sm-3 form-group">
                                ...
                                value="<?php displayVal("dob", $profile); ?>"/>
							...
							<div class="col-sm-3 form-group">
                                ...
                                value="<?php displayVal("email", $profile); ?>">
                        ...
                        <div class="row">                       
                            <div class="col-sm-6 form-group">
                                <label>Gender:</label>
								<input type="text" id="gender_input"  
                                class="form-control" name="gender" 
                                value="<?php 
                                displayVal("gender", $profile);?> "/>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" id="rcity_input" placeholder="city"
                           name="rcity" value="<?php 
                            displayVal("rcity", $profile); ?>"/>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" id="rstate_input" placeholder="state"
                           name="rstate" value="<?php 
                            displayVal("rstate", $profile); ?> "/>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          ...
                          value="<?php displayVal("rpin", $profile); ?>"/>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          ...
                          value="<?php displayVal("rphone", $profile); ?>"/>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          ...
                          value="<?php displayVal("rfax", $profile); ?>"/>
                    ...
                    <label><h4>Office Address</h4></label>  
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          ...
                          value="<?php displayVal("ostreet", $profile); ?>"/>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          ...
                          value="<?php displayVal("ocity", $profile); ?>"/>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          ...
                          value="<?php displayVal("ostate", $profile); ?>"/>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          ...
                          value="<?php displayVal("opin", $profile); ?>"/>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          ...
                          value="<?php displayVal("ophone", $profile); ?>"/>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          ...
                          value="<?php displayVal("ofax", $profile); ?>"/>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="col-md-10">	 
                        ...
                        value="<?php displayVal("extra", $profile); ?>"/>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="col-md-3">
                      ...
                      <div class="col-md-9">
                        ...
                        src="image/<?php echo $profile['photo'];?>"/><br/>	 
